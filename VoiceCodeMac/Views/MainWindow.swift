// MainWindow.swift
// VoiceCodeMac — Top-level window view with sidebar, layout preview, and toolbars
...
struct MainWindow: View {
    ...
    private func arrangeWindows() {
        // Use NSScreen directly as fallback if displays list is empty
        ...
        if let display = selectedDisplay {
            ...
            print("[MainWindow] No display available for arrangement")
            return
        }
